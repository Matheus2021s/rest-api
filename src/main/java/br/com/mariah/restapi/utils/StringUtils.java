...
public class StringUtils {
    ...
    private static String getWordWithFirstLetterUpperAndRestLower(String value) {
        return getFirstLetterUpperCase(value) + getTextWithoutFirstLetterLowerCase(value);
    }

    private static String getWordWithFirstLetterUpper(String word) {
        return getFirstLetterUpperCase(word) + getTextWithoutFirtsLettter(word);
    }


    private static String getWordWithFirstLetterLower(String word) {
